...
int main(void)
{
	  ...
	  HAL_TIM_Base_Start_IT(&htim3);       /* TIM3 :ms IRQ */
	  HAL_TIM_Base_Start(&htim2);             /*Counter everus */
...
void Print_Status(void)
{
    ...
    int  spdd = (int)(ev.speed_kmh * 10) % 10;
    int  soc  = (int)ev.soc;
    int  socd = (int)(ev.soc * 10) % 10;
    int  tmp  = (int)ev.motor_temp;
    int  tmpd = (int)(ev.motor_temp * 10) % 10;
